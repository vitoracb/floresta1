  ...
  return (
    <View style={styles.tabContainer}>
      <View style={styles.filterContainer}>
        ...
        >
          <Text style={[styles.filterText, selectedType === 'GENERAL' && styles.activeFilterText]}>Gerais</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.filterButton, selectedType === 'MONTHLY' && styles.activeFilterButton]} 
          onPress={() => setSelectedType('MONTHLY')}
        >
          <Text style={[styles.filterText, selectedType === 'MONTHLY' && styles.activeFilterText]}>Mensais</Text>
        </TouchableOpacity>
      </View>
